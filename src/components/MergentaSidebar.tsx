...
const MergentaSidebar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-20 bg-gradient-to-b from-purple-50 to-purple-100 border-r border-purple-200 z-40 flex flex-col items-center shadow-lg">
        {/* Logo Section */}
