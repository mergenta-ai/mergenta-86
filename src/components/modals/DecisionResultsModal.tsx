          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {decisionCards.map((card, index) => (
                <div 
                  key={card.id}
                  className="bg-[#F3D1FA] hover:bg-[#E7B9F2] text-mergenta-dark-grey rounded-2xl p-6 shadow-soft hover:shadow-elegant transform transition-transform duration-300 hover:-translate-y-1 hover:scale-105 will-change-transform animate-in slide-in-from-bottom-4"
