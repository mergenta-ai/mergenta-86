          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative">
              ...
              <img 
                ...
                alt="Mergenta Logo" 
                className="relative h-20 w-20 object-contain rounded-full shadow-lg" 
              />
            </div>
        ...
        <CardContent>
          ...
          <div className="space-y-3 mb-6">
            ...
            <Button
              ...
              className="w-full bg-white/60 border-pastel-violet/50 hover:bg-white/90 hover:border-mergenta-violet/30 text-foreground font-medium py-3 transition-all duration-300 shadow-sm hover:shadow-md group"
            >
              <svg className="w-5 h-5 mr-3 flex-shrink-0 text-foreground" viewBox="0 0 24 24" fill="currentColor">
