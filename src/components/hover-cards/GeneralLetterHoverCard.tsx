...
const GeneralLetterHoverCard = ({ children, onPromptGenerated }: GeneralLetterHoverCardProps) => {
  ...
  const { draftData, saveDraft, clearDraft, isLoading } = useDraftPersistence({
    cardId: "general-letter",
    initialData: { to: "", subject: "", coreMessage: "", finalTouch: "", signOff: "", from: "" },
  });

  // stable string locals to avoid controlled/uncontrolled warnings
      ...
      {showCard && (
        <div className="fixed inset-0 z-[200] pointer-events-none">
          <div
            ...
            className="absolute left-[910px] top-[165px] w-80 pointer-events-auto"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Friend, colleague, organisation, contact, relative, teacher, neighbour, authority, client, group, team, company..."
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onClick={(e) => e.stopPropagation()}
                      placeholder="Update, sharing, greetings, information, invitation, appreciation, announcement, feedback, reminder, etc..."
                      className="w-full min-h-[60px] resize-none"
                      autoComplete="off"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onClick={(e) => e.stopPropagation()}
                      placeholder="Key points, general info, notes, communication, thoughts, reminders, updates, news, suggestions, remarks..."
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onClick={(e) => e.stopPropagation()}
                      placeholder="Additional notes, clarification, highlights, explanations, details..."
                      className="w-full min-h-[60px] resize-none"
                      autoComplete="off"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onClick={(e) => e.stopPropagation()}
                      placeholder="Looking forward, best regards, with appreciation, sincerely, etc..."
                      className="w-full min-h-[60px] resize-none"
                      autoComplete="off"
                    />
                  </div>
