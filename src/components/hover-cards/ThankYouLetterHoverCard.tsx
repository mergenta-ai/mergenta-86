...
const ThankYouLetterHoverCard = ({ children, onPromptGenerated }: ThankYouLetterHoverCardProps) => {
  const [showCard, setShowCard] = useState(false);
  const closeTimeoutRef = useRef<NodeJS.Timeout | null>(null);

  const { draftData, saveDraft, clearDraft, isLoading } = useDraftPersistence({
    cardId: "thank-you-letter",
    initialData: { to: "", subject: "", coreMessage: "", finalTouch: "", signOff: "", from: "" },
  });

  // always-string locals to avoid controlled/uncontrolled switching
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onClick={(e) => e.stopPropagation()}
                      placeholder="Gratitude, Appreciation, Recognition, Thankfulness, etc..."
                      className="w-full min-h-[60px] resize-none"
                      autoComplete="off"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onClick={(e) => e.stopPropagation()}
                      placeholder="Express sincere thanks, your support, guidance, kindness, etc..."
