...
const LeaveApplicationHoverCard = ({ children }: LeaveApplicationHoverCardProps) => {
  ...
  return (
    ...
    >
      ...
      {showCard && (
        <div 
          className="absolute left-full top-0 w-80 bg-pastel-lavender rounded-2xl shadow-lg border border-[#E5D9F2] z-50 p-6"
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-[#5B34A0] mb-1">Leave Application</h3>
              <p className="text-sm text-[#6E6E6E] mb-4">Apply for leave from work or institution</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                onClick={() => console.log("Start Leave Application")}
              >
